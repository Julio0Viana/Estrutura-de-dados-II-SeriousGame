...
| **Mecânica do visualizador** | Árvore BST(Árvore Binária de Busca sem balancemento)  com complexidade O(n) na maioria dos casos | Árvore BST + Árvore AVL(auto-balanceada)com complexidade de tempo O(log n) na maioria dos casos com rotações de balanceamento |
